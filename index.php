    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px;
            ...
            <div>
                ...
                <div u="caption" t="FADE" du="1000" style="position:absolute;top:135px;left:100px;width:150px;height:30px;color:#ffffff;font-size:26px;line-height:30px;text-align:center;">RTT|10</div>
                <div u="caption" t="FADE" du="4000" t2="NO"  style="position: absolute; width: 102px; height: 78px; top: 70px; left: 130px;" />ahoooj</div>
            <div u="caption" t="FADE" du="4000" style="position: absolute; width: 102px; height: 78px; top: 170px; left: 130px;" />ahoooj</div>
            <div u="caption" t="FADE" du="4000" style="position: absolute; width: 102px; height: 78px; top: 270px; left: 130px;" />ahoooj</div>
                    
                <div style="position: absolute; width: 100%; height: 120px; top: 300px; left: 300px; padding: 5px;
                    text-align: left; line-height: 36px; font-size: 30px; text-transform: uppercase; text-align: center;
                        color: #FFFFFF;">
                        Premium Quality Czech glass
                </div>
            </div>
            <div>
